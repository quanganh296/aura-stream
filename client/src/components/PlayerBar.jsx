...
import { 
  ...
  Volume2, VolumeX, ListMusic, Mic2, HelpCircle
} from 'lucide-react';
...
const PlayerBar = ({ showFullPlayer, setShowFullPlayer }) => {
  ...
  return (
    <div className="player-bar-container glass-panel">
      {/* 1. Track Info (Left) */}
      <div className="player-track-info" onClick={() => setShowFullPlayer(!showFullPlayer)}>
        <TrackImage 
